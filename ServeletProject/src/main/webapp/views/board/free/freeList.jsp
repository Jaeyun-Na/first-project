...
<body>
	...
	<section>
		...
		<input type="hidden" name="cpage" value="1">
			<input type="search" name="searchText" placeholder="검색어를 입력하세요">
			...
			<nav aria-label="Page navigation example">
				<ul class="pagination">
					<c:choose>
						...
						<c:otherwise>
							<li class="page-item"><a class="page-link"
								href="/freeList.do?cpage=${pi.currentPage-1 }&searchText="${searchText }"
								aria-label="Previous"> <span aria-hidden="true">&laquo;</span>
							</a></li>
						</c:otherwise>
					</c:choose>
					...
					<c:forEach var="page" begin="${pi.startPage }" end="${pi.endPage }">
						<li class="page-item"><a class="page-link"
							href="/freeList.do?cpage=${page}&searchText="${searchText }">${page}</a></li>
					</c:forEach>
					...
					<c:choose>
						...
						<c:otherwise>
						<li class="page-item">
							<a class="page-link" href="/freeList.do?cpage=${pi.currentPage+1 }&searchText="${searchText }"
